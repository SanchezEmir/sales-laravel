		...
		<div class="widget widget-chart-one">
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills">
                    <!-- este permiso Product_create los iras incorporando con las clases, como ahorita el user no tiene el permiso no deja crear, solo quitarlo temporalmente -->
...
//aparentemente no sucede nada, en la vista no ves los botones, solo debes limpiar cache y cerrar sesion
